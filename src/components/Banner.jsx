...
const Banner = () => {
  ...
  return (
    <Flex h={["120vh", "100vh"]} flexDirection={"column"} bgImage="boats.jpeg" bgSize="cover" bgPosition="center" width={"full"} alignItems={"center"} px={["7", 0]} justify="center" textColor="white">
